      ...
      <v-row>
        <v-col cols="12">
          ...
          <ul>
            ...
            <li>
              <p><strong>Organization</strong> (referred to as either &quot;the Organization&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to SCU Association for Computing Machinery Student Organization, 500 El Camino Real, Santa Clara, CA 95053.</p>
            </li>
            <li>
            ...
            <li>
              <p><strong>Website</strong> refers to SCU ACM, accessible from scuacm.com</p>
            </li>
            <li>
          ...
          <p>If You decide to register through or otherwise grant us access to a Third-Party Social Media Service, We may collect Personal data that is already associated with Your Third-Party Social Media Service's account, such as Your name, Your email address, or Your SCU affiliation associated with that account.</p>
          ...
          <ul>
            ...
            <li><strong>With business partners:</strong> We may share Your information with Our partners to offer You certain deals, services or promotions.</li>
...
<style scoped>
/* Add any CSS you need to style your page here */
</style>